...
$objPHPExcel2 = PHPExcel_IOFactory::load('../reportesgenerados/Memberships-'.$userid.'.xlsx');
$objPHPExcel3 = PHPExcel_IOFactory::load('../reportesgenerados/EnrollmentFees-'.$userid.'.xlsx');
$objPHPExcel4 = PHPExcel_IOFactory::load('../reportesgenerados/Dues-'.$userid.'.xlsx');
...
$objPHPExcel->getActiveSheet()->getPageSetup()->setOrientation(PHPExcel_Worksheet_PageSetup::ORIENTATION_LANDSCAPE);
$objPHPExcel->getActiveSheet()->getPageSetup()->setPaperSize(PHPExcel_Worksheet_PageSetup::PAPERSIZE_A4);
$objPHPExcel->getActiveSheet()->setTitle('FullReport');
$objPHPExcel->setActiveSheetIndex(0);
$objPHPExcel->removeSheetByIndex(0);
$callStartTime = microtime(true);
$objWriter = new PHPExcel_Writer_Excel2007($objPHPExcel);
