...
timestamp(persona.per_fechanacimiento) as per_fechanacimiento,  
...
(SELECT  concat (persona.per_nombre ,' ', persona.per_apellido) 
                ...
                as 'nombre_forum',
(SELECT `mie_ins_id` FROM `miembro_inscripcion` WHERE miembro_id=miembro.mie_id limit 1) as 'inscripcion',
