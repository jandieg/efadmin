...
//            $listaStatus['lista_'] = array("value" => "x",  "select" => "" ,"texto" => "Seleccionar...");
        ...
        global $lblForumLeader,$lblNombre, $lblApellido , $lblTipoPersona, $lblIdentificacion, $lblGenero,
                ...
                $lblbtnGuardar, $lblbtnRegresar,$lblListaHobbies;
        //Formularios
        ...
        $form7['form_10'] = array("elemento" => "caja" ,"tipo" => "text" , "titulo" => $lblCorreoSecundario, "id" => "_correo_2" ,"reemplazo" => $correo_2);
        ...
        $form8['form_13'] = array("elemento" => "caja pequeña + caja" ,"titulo" => $lblTF
                                                       ...
                                                       ,"disabled_2" => "","tipo_2" => "number" , "titulo_2" => $lblTF, "id_2" => "_telefono" ,"reemplazo_2" => $t_fijo);
        ...
        $form8['form_14'] = array("elemento" => "caja pequeña + caja" ,"titulo" => $lblTM
                                           ...
                                           ,"disabled_2" => "","tipo_2" => "number" , "titulo_2" => $lblTM, "id_2" => "_celular" ,"reemplazo_2" => $t_movil);
		if($_SESSION['_esaplicante'] == '1'){
...
//	$form['form_4'] = array("elemento" => "combo","change" => "", "titulo" => $lblTipoPersona, "id" => "_tipo_p", "option" => generadorComboTipoPersona_($row['per_tipo']));          
        ...
        $form['form_7'] = array("elemento" => "caja", "tipo" => "hidden", "id" => "_titulo", "reemplazo" => "");
       ...
       $form2['form_1'] = array("elemento" => "caja","tipo" => "hidden", "id" => "_propietario", "reemplazo" => "1");
        ...
        switch ($_POST['KEY']): 
			...
			if($_SESSION['_esaplicante'] == '1'){
                    ...
                    //    $tabla6['t_15'] = array("t_1" => generadorNegritas($lblTwitter), "t_2" => $row['twitter']);
                        ...
                        $tabla2['t_7'] = array("t_1" => generadorNegritas($lblEmpresa), "t_2" => $row['emp_nombre']);
				if($_SESSION['_esaplicante'] == '1'){
			...
			if (($_SESSION['user_user']=='admin')||($_SESSION['user_user']=='ibp')||($_SESSION['user_user']=='leader')) {
...
if($_SESSION['_esaplicante'] == '1'){
	                 $form['form_4'] = array("elemento" => "combo","change" => "","titulo" => $lblTipoPersona, "id" => "_tipo_p", "option" => generadorComboTipoPersona_('J'));                 $form['form_5'] = array("elemento" => "caja" ,"tipo" => "number" , "titulo" => $lblIdentificacion, "id" => "_identificacion" ,"reemplazo" => "");
                 ...
                 $form7['form_10'] = array("elemento" => "caja" ,"tipo" => "text" , "titulo" => $lblCorreoSecundario, "id" => "_correo_2" ,"reemplazo" => "");
                ...
                if($_SESSION['_esaplicante'] == '1'){
                 ...
                 $form2['form_4'] = array("elemento" => "textarea" ,"tipo" => "text" , "titulo" => "Persona que Refiere", "id" => "_lafuente" ,"reemplazo" => '');
                 if($_SESSION['_esaplicante'] == '1'){
                    $form2['form_5'] = array("elemento" => "combo","change" => "", "titulo" => $lblEstadoProspecto, "id" => "_estado_propietario", "option" => $listaestadoprospecto);
                 }
                 $form2['form_6'] = array("elemento" => "combo + boton","change" => "",                   "titulo" => generadorAsterisco("Empresa"), "id" => "_id_empresa", "option" => $listaEmpresas, 
                                            "modal" => "","boton_click" => "getPAMEmpresaModal('1')", "boton_icono" => "fa fa-industry","boton_nombre" => "", "boton_title" =>"Crear Empresa"
                                            ,"boton_tipo" => "btn-info");
...
function getTablaFiltrada($id, $key, $esaplicante) {
   ...
   $objProspesto= new Prospecto();
    ...
    if($_SESSION['_esaplicante'] == '0'){
        ...
        $tabla= generadorTabla_(1, "Aplicante",$funcion, array( "N°","Nombre","Forum Leader"), $cuerpo);
    }
   return $tabla;
