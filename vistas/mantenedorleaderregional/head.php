<?php 
require_once MODELO2.'GlobalLiderRegional.php';
                    ...
                    if(isset($_POST['id'])){ 
                        ...
                        $resultset= $objUsuario->getUser($_POST['id']);
                         if($row = $resultset->fetch_assoc()) {
                            ...
                            $listaPerfil= $objPerfil->getListaPerfiles($row['perfil_per_id'],NULL,'1');
...
//                            $listaSedes= $objSede->getLista($row['sede_id'],$lista);
                            ...
                            //Formularios
                            $form['form_1'] = array("elemento" => "caja" ,"tipo" => "text" , "titulo" => "Nombre", "id" => "_nombre" ,"reemplazo" => $row['per_nombre']);
                            $form['form_2'] = array("elemento" => "caja" ,"tipo" => "text" , "titulo" => "Apellido", "id" => "_apellido" ,"reemplazo" => $row['per_apellido']);
                            $form['form_4'] = array("elemento" => "combo","change" => "", "titulo" => "Tipo de Persona", "id" => "_tipo_p", "option" => generadorComboTipoPersona(($row['per_tipo']=="N" ? "Natural" : "Jurídica")));                
                            $form['form_5'] = array("elemento" => "caja" ,"tipo" => "text" , "titulo" => "Identificación", "id" => "_identificacion" ,"reemplazo" => $row['per_identificacion']);         
                            $form['form_6'] = array("elemento" => "caja" ,"tipo" => "date" , "titulo" => "Fecha de Nacimiento", "id" => "_fn", "reemplazo" => $row['per_fechanacimiento']); 
                            $form['form_7'] = array("elemento" => "combo","change" => "",  "titulo" => "Genero", "id" => "_genero", "option" => generadorComboGenero($row['per_genero']));
                            $form['form_8'] = array("elemento" => "combo","change" => "","titulo" => "Perfil", "id" => "_perfil", "option" => $listaPerfil);  
//                            $form['form_9'] = array("elemento" => "combo", "change" => "",                  "titulo" => "Sede", "id" => "_sede", "option" => $listaSedes);
                            $form['form_15'] = array("elemento" => "caja" ,"tipo" => "text" , "titulo" => "Correo", "id" => "_correo" ,"reemplazo" => $correo_1);
                            $form['form_16'] = array("elemento" => "caja" ,"tipo" => "number" , "titulo" => "Telefono", "id" => "_telefono" ,"reemplazo" => $t_fijo);
                            $form['form_17'] = array("elemento" => "caja" ,"tipo" => "number" , "titulo" => "Celular", "id" => "_celular" ,"reemplazo" => $t_movil);
                            
                            
                            $form['form_11'] = array("elemento" => "combo","change" => "","titulo" => "Estado", "id" => "_estado", "option" => generadorComboEstado(($row['usu_estado']=="A" ? "Activo" : "Inactivo")));                
...
//                $listaSedes= $objSede->getLista(NULL,$lista);
                ...
                //Formularios
                $form['form_1'] = array("elemento" => "caja" ,"tipo" => "text" , "titulo" => "Nombre", "id" => "_nombre" ,"reemplazo" => "");
                $form['form_2'] = array("elemento" => "caja" ,"tipo" => "text" , "titulo" => "Apellido", "id" => "_apellido" ,"reemplazo" => "");
                $form['form_4'] = array("elemento" => "combo","change" => "","titulo" => "Tipo de Persona", "id" => "_tipo_p", "option" => generadorComboTipoPersona('Natural'));                
                $form['form_5'] = array("elemento" => "caja" ,"tipo" => "number" , "titulo" => "Identificación", "id" => "_identificacion" ,"reemplazo" => "");         
                $form['form_6'] = array("elemento" => "caja" ,"tipo" => "date" , "titulo" => "Fecha de Nacimiento", "id" => "_fn", "reemplazo" => ""); 
                $form['form_7'] = array("elemento" => "combo", "change" => "",   "titulo" => "Genero", "id" => "_genero", "option" => generadorComboGenero('MASCULINO'));
                $form['form_8'] = array("elemento" => "combo","change" => "","titulo" => "Perfil", "id" => "_perfil", "option" => $listaPerfil);               
//                $form['form_9'] = array("elemento" => "combo", "change" => "",                  "titulo" => "Sede", "id" => "_sede", "option" => $listaSedes);

                $form['form_15'] = array("elemento" => "caja" ,"tipo" => "text" , "titulo" => "Correo", "id" => "_correo" ,"reemplazo" => "");
                $form['form_16'] = array("elemento" => "caja" ,"tipo" => "number" , "titulo" => "Telefono", "id" => "_telefono" ,"reemplazo" => "");
                $form['form_17'] = array("elemento" => "caja" ,"tipo" => "number" , "titulo" => "Celular", "id" => "_celular" ,"reemplazo" => "");
                ...
                $form['form_11'] = array("elemento" => "combo","change" => "","titulo" => "Estado", "id" => "_estado", "option" => generadorComboEstado('Activo'));   
...
//                        }
                        ...
                        if($_POST['_contraseña'] != $_POST['_confirmar'] ){
                            $data = array("success" => "false", "priority"=>'success',"msg" => 'El user no coincide con la confirmación!');  
                            echo json_encode($data); 
                            exit();
                        }
...
////////////////////////////////////////////////////////////////////////////////
setDatosConexion(1);
$objLiderRegional= new GlobalLiderRegional();
$cuerpo='';
$cont=1;
$resultset= $objLiderRegional->gets();
 while($row = $resultset->fetch_assoc()) { 
  
     $cuerpo.= generadorTablaFilas(array(
          "<center>".$cont."</center>",
         generadorLink($row['per_nombre'].' '.$row['per_apellido'],'_getActualizar('.$row['usu_id'].')'),
         $row['movil'],
         $row['correo'],
         $row['usu_estado']));  
     $cont=$cont + 1; 
 }    
 $t= generadorTabla_(1, "Lider Regional",'getCrear()', array("N°", "Nombre","Móvil","Correo","Estado"), $cuerpo);
